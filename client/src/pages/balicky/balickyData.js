export const defaultBalickyData = {
  ...
  whySection: {
    ...
    cards: [
      ...
      {
        icon: 'bolt',
        title: 'Rychlá instalace obou služeb',
        text: 'Internet i televizi zprovozníme v rámci jedné návštěvy technika, bez opakovaných termínů.',
      },
      {
        icon: 'clock',
        title: 'TV archiv a chytré funkce',
        text: 'IPTV Genius přidá možnost zpětného sledování pořadů a další funkce pro každodenní komfort sledování.',
      },
      {
        icon: 'fiber',
        title: 'Optika tam, kde je dostupná',
        text: 'Balíčky primárně využívají optickou přípojku FTTH, která zajišťuje nejvyšší stabilitu a rychlost internetu.',
      },
    ],
  },
};
